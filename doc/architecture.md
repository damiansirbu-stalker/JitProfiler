...
The results table ranks each function by own with an own-share bar, plus own ms, total ms, and calls, under a frame-budget bar reading own ms per frame against a 60fps frame.
